...
quizButton.addEventListener('click', () => {
    ...
    const roundedPercent = counterToPercentage(correctCounter);

    //array of possible result messages
    displayResultString(firstName, lastName, roundedPercent, correctCounter);

    // change style depending on how many correct
    styleSelector(correctCounter);
});